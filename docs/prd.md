...
- **Links:** all prototype links work; the deployed prototype is available at https://web3-participation-loop-main.vercel.app (journey at `#journey`, dashboard at `#dashboard`).
