...
- New tests added (≥ 8), existing 103 unit tests stay green, strict typecheck passes.
...
- No regression in the existing 103 unit tests; strict typecheck passes; calibration is
...
- ≥ 8 new tests; existing 103 unit tests stay green; strict typecheck passes.
...
- ≥ 6 new tests; existing 103 unit tests stay green; strict typecheck passes.
