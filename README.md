...
- `prototype/test/` — Vitest suites (101 tests)
...
A recorded walkthrough of the six scenarios and the operations dashboard accompanies this submission
(Notion submission hub / Loom). All data shown is synthetic.
